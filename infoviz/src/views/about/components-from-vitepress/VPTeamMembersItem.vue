<script>
import VPSocialLinks from "@/views/about/components-from-vitepress/VPSocialLinks.vue";

export default {
  components: {VPSocialLinks},
  props: ['member', 'size'],
}
</script>
...
.VPTeamMembersItem.small .avatar-img {
  width: 64px;
  height: 64px;
}
...
.VPTeamMembersItem.medium .avatar-img {
  width: 96px;
  height: 96px;
}
